...
@interface EnnPlusButtonSubclass ()<UIActionSheetDelegate> {
    CGFloat _buttonImageHeight;
}

@end

@implementation EnnPlusButtonSubclass
 ...
 */
+ (id)plusButton {
    EnnPlusButtonSubclass *button = [[EnnPlusButtonSubclass alloc] init];
